@extends('master')
@section('title', 'SoftLand Bootstrap Template - Index')
@section('content')
<!-- ======= Hero Section ======= -->
        ...
        <div class="col-12 hero-text-image">
          <div class="row">
            ...
            <div class="col-lg-4 iphone-wrap">
              <img src="{{asset('img/phone_1.png')}}" alt="Image" class="phone-1" data-aos="fade-right">
              <img src="{{asset('img/phone_2.png')}}" alt="Image" class="phone-2" data-aos="fade-right" data-aos-delay="200">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        <div class="row justify-content-center text-center mb-5" data-aos="fade">
          <div class="col-md-6 mb-5">
            <img src="{{asset('img/undraw_svg_1.svg')}}" alt="Image" class="img-fluid">
          </div>
        </div>
