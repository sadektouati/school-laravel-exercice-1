@extends('master')
@section('title', 'Contact - SoftLand Bootstrap Template')
@section('content')
    ...
    <section class="section">
      <div class="container">
        ...
        <div class="row">
          ...
          @isset($donnees)
            <p><strong>Name: </strong>{{ $donnees->name ?? ''}}</p>
            <p><strong>Courriel: </strong>{{ $donnees->email ?? ''}}</p>  
            <p><strong>Subject: </strong>{{ $donnees->subject ?? ''}}</p>  
            <p><strong>Message: </strong>{{ $donnees->message ?? ''}}</p>
          @else
